...
import dragon.framework.context.AppContextUtil;
 ...
 */
public class AppContextDataSource implements javax.sql.DataSource {

    //Local variables
    /**
     * 默认数据源
     */
    private javax.sql.DataSource defaultDateSource;
    ...
    protected javax.sql.DataSource getDataSource() {
        javax.sql.DataSource result;
        String dataSource = ThreadContext.get("dataSource");
        if(StringUtils.isNotBlank(dataSource)){
            result = AppContextUtil.bean(dataSource);
        }else{
            result = defaultDateSource;
        }
        return result;
    }
     ...
     */
    public void setDefaultDateSource(javax.sql.DataSource defaultDateSource) {
